...
const Profile = ({ user, onProfileUpdate }) => {
      ...
      if (user && user.uid) {
        try {
          ...
          if (result.success) {
            ...
            setIsProfileSaved(true); // Profile already exists
  ...
  return (
    <div className="fitness-profile">
      <h2>Fitness Profile {isProfileSaved ? 'Editor' : 'Setup'}</h2>
          ...
          <div className="form-step">
            ...
            <div className="form-navigation">
              ...
              <button 
                ...
                disabled={loading}
              >
                {loading ? 'Saving...' : (isProfileSaved ? 'Update Profile' : 'Save Profile')}
              </button>
            </div>
          </div>
        )}
      ...
      {/* Show Edit Profile button if profile is already saved */}
      {isProfileSaved && step !== 4 && (
        <div className="edit-profile-button-container">
          <button 
            type="button" 
            className="edit-profile-button subtle-admin-button"
