      ...
      <div className="footer-container">
        ...
        <div className="footer-partners-top">
          <div className="moving-logos">
            ...
            {/* New sponsors added here */}
            <img src="/decode.png" alt="Decode" className="partner-logo" />
        ...
        <div className="footer-main">
          ...
          <div className="footer-brand-card">
            ...
            <div className="social-links">
              ...
              <a href="mailto:runanddevelop@gmail.com" className="social-link" aria-label="Email" target="_blank" rel="noopener noreferrer">
                <FaEnvelope />
              </a>
          ...
          <CollapsibleSection title="Contact" defaultOpen={isDesktop} forceOpen={isDesktop}>
            <div className="contact-info">
              <div className="contact-item">
                ...
                <span>Vijaya Nagar, 11, post, near Rettipalaiyam Road, Srinivasapuram, Wahab Nagar, Thanjavur, Tamil Nadu 613009.</span>
              </div>
              <div className="contact-item">
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <p>&copy; 2025 RunAndDevelop. All rights reserved.</p>
