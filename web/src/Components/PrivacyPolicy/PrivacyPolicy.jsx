    ...
    <>
      ...
      <div className="privacy-policy">
        <div className="privacy-policy-container">
          ...
          <h1>Privacy Policy — Run and Develop</h1>
          
          <p>Run and Develop is a fitness event management platform connecting running enthusiasts in the community. We organize weekly running events, provide fitness tracking tools, and facilitate event bookings. This Privacy Policy explains how we collect, use, store, and protect your personal information when you use our website and services. By accessing our website, you agree to the practices described in this policy.</p>
